    ...
    def get_train_dataloader(self):
        def _create_loader(dataset, num_workers, bsz, collate_fn=None, is_train=True):
            ...
            if isinstance(dataset, ChainDataset) or isinstance(
                ...
                seed_temp = self.args.seed if self.args.seed else 42
                if get_rank() == 0:
                    print(f"sampler self.args = {self.args}")
                print(f"sampler seed = {seed_temp}, rank = {get_rank()}") # used, and get_rank() works
    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            if self.args.mm_projector_lr is not None:
                print("self.args.mm_projector_lr is not None")
