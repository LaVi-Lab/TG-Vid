...
from nextqa_atp_hard import NextQA_ATP_HARD_dataset, infer_NextQA_ATP_HARD, check_ans
import argparse
import os
...
def parse_args():
    ...
    parser.add_argument("--anno-path", required=True, help="path to NextQA_ATP_HARD annotation.")
...
def run_inference(args):
    ...
    acc_dict = {}
    videos_len = []
    dataset = NextQA_ATP_HARD_dataset(args.anno_path, num_segments=args.num_frames, resolution=224, specified_item = args.specified_item)
