...
data_list = {
    "nextqa_atp_hard_causal": ("nextqa_atp_hard_causal.json", "/path/to/NextQA/NExTVideo/", "video", False),
    "nextqa_atp_hard_temporal": ("nextqa_atp_hard_temporal.json", "/path/to/NextQA/NExTVideo/", "video", False),
}

data_dir = "/path/to/Data-TG-Vid/Testing/NextQA-ATP-Hard"

class NextQA_ATP_HARD_dataset(Dataset):
...
if __name__ == "__main__":
    dataset = NextQA_ATP_HARD_dataset(data_dir, data_list, num_segments=16, resolution=224)