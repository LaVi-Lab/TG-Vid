...
from tempcompass import TempCompass_dataset, infer_TempCompass, check_ans
import argparse
import os
...
def parse_args():
    ...
    parser.add_argument("--anno-path", required=True, help="path to TempCompass annotation.")
...
def run_inference(args):
    ...
    acc_dict = {}
    videos_len = []
    dataset = TempCompass_dataset(args.anno_path, num_segments=args.num_frames, resolution=224, specified_item = args.specified_item)
