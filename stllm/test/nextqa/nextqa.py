...
data_list = {
    "nextqa_val_causal": ("nextqa_val_causal.json", "/path/to/NextQA/NExTVideo/", "video", False),
    "nextqa_val_temporal": ("nextqa_val_temporal.json", "/path/to/NextQA/NExTVideo/", "video", False),
    "nextqa_val_descriptive": ("nextqa_val_descriptive.json", "/path/to/NextQA/NExTVideo/", "video", False),
}

data_dir = "/path/to/Data-TG-Vid/Testing/NextQA"
...
if __name__ == "__main__":
    dataset = NextQA_dataset(data_dir, data_list, num_segments=16, resolution=224)